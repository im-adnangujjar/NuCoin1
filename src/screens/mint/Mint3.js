    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.subContainer}>
        ...
        <View style={styles.button_align}>
          {data.map((item, index) => {
            return <WalletButton item={item} />;
          })}
        </View>
        <View style={styles.card}>
          <Text style={styles.text}>
            pipe rush chance peel bottom appararatus chew democratic wash make
            chicken national
          </Text>
        </View>
        <Button
          onPress={() => navigation.navigate('Wallet2')}
          text="Load Mnemonic"
          width="100%"
          bgColor="#282B33"
        />
        <View style={styles.button}>
          <Button
            onPress={() => navigation.goBack('Mint4')}
            text="Cancel"
            bgColor="#F3F3F3"
            color="black"
          ...
          />
          <GradientButton1
            click={() => navigation.navigate('Mint4')}
            text="Continue"
            width={Platform.OS==='ios'?170:150}
